...
PHASE 0 / TASK-004의 App Shell 위에 PHASE 1의 프로젝트 생성·조회, 상품정보 입력과 이미지 등록을 연결한다.
...
- `/projects/[projectId]/images`: 저장된 상품의 이미지 등록·조회·삭제
- `/templates`: 템플릿
- `/settings`: 설정
...
- 이후 AI 분석 단계는 안내 문구만 있으며 실행 버튼이나 AI 기능은 없다.
