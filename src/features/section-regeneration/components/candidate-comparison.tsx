...
export function CandidateComparison({ current, candidate, busy, onApply, onKeep }: { current: EditorSection; candidate: Candidate; busy: boolean; onApply: () => void; onKeep: () => void }) {
